...
import RiskCalculator from '../components/RiskCalculator'; // Import Calculator
import KeyboardShortcuts from '../components/KeyboardShortcuts'; // Import Shortcuts
...
export default function TradeWall() {
    ...
    // פונקציה לעדכון מצב הנעילה וגם שמירה ב-localStorage
    ...
    // Initial Load & WebSocket & Restore Lock State
    useEffect(() => {
        // שחזור מצב הנעילה מה-LocalStorage
        if (typeof window !== 'undefined') {
